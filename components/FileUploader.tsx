...
import useUpload, { StatusText } from "@/lib/hooks/useUpload";
  ...
  return (
    <div className="flex flex-col gap-4 items-center max-w-7xl mx-auto">
      ...
      {!uploadInProgress && (
        <div
          {...getRootProps()}
          className={`p-10 border-indigo-600 text-indigo-600 border-2 border-dashed mt-10 w-[90%] rounded-lg h-96 flex items-center text-center justify-center ${
